...
- WOOL CREPE is one of the most important fabrics to identify for structured designer garments. The signs: smooth matte surface with no visible weave texture, holds a crisp silhouette (A-line, fitted bodice) without collapsing, shows ZERO wrinkles or creasing even in movement, has body and structure but is not stiff like cotton. A structured designer dress that looks wrinkle-free with a smooth matte finish is almost certainly wool crepe (or wool-blend crepe). Cotton poplin and cotton sateen wrinkle. Polyester crepe looks shinier. Wool crepe is the only fabric that is simultaneously matte, structured, wrinkle-free, and smooth. For premium brands, lead with "wool crepe with elastane" when you see these properties.
